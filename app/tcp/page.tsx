    ...
    <main className="min-h-screen bg-white font-neue-haas">
      ...
      <section className="py-32 bg-black text-white">
        <div className="container mx-auto px-4 text-center space-y-12">
          ...
          <button className="px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 text-white border border-white hover:bg-white hover:text-black transition-colors text-xs sm:text-sm md:text-base uppercase tracking-wide">
