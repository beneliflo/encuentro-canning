  ...
  return (
    <main className="bg-[url('/bg-preview.png')] before:bg-section-pattern before:absolute before:inset-0 bg-cover bg-no-repeat bg-top">
      <div className="relative flex flex-col items-center justify-center min-h-screen">
        <Link href="/">
          <Image
            className="w-10 pt-8 cursor-pointer sm:w-14"
            src={logoIEC}
            alt="IEC Logo"
            loading="eager"
          />
        ...
        <div className="relative">
          <div className="container text-center py-14 md:py-20">
            <div className="flex flex-col justify-center text-white xl:flex-row">
              <h1 className="text-4xl font-semibold md:text-5xl xl:pr-10 xl:mr-10 xl:border-r-2 xl:border-r-white">
                Hipócrates 3320 - Canning
              </h1>
              <p className="mt-6 text-3xl md:text-5xl xl:mt-0">
                Domingos 10:00 AM
              </p>
            </div>
            <div
              className="overflow-hidden mt-14 rounded-2xl"
        ...
        <ul className="flex items-center gap-8 pb-8">
          <li>
            <Link
              href="https://www.facebook.com/ElEncuentro.Canning"
              target="_blank"
            >
              <Image
                className="w-8 transition-opacity duration-150 ease-in-out hover:opacity-80"
                src={FacebookIcon}
                alt="facebook icon"
                loading="eager"
              />
          ...
          <li>
            <Link
              href="https://www.youtube.com/@encuentrocanning"
              target="_blank"
            >
              <Image
                className="w-10 transition-opacity duration-150 ease-in-out hover:opacity-80"
                src={YoutubeIcon}
                alt="youtube icon"
                loading="eager"
              />
